...
def get_roi_and_lbp(image):
    try:
        ...
        landmark_distance = math.hypot(landmark_2[1] - landmark_1[1], landmark_2[0] - landmark_1[0])
        ...
        top_left_point = np.array([landmark_1[0] - distance_from_fingers, landmark_1[1]])
        top_right_point = np.array([landmark_2[0] - distance_from_fingers, landmark_2[1]])
